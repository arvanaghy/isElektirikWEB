        ...
        <div className="relative min-h-[15vh] py-8 px-6 bg-black w-full flex flex-col justify-center items-center text-white">
            <div className="flex lg:flex-row flex-col w-full lg:space-x-8 space-y-5">
                ...
                <div className="w-full lg:w-4/12 z-10">
                    <p className="text-xl text-center font-extrabold w-10/12 lg:w-4/12 m-auto pb-2 border-b-[1px]  mb-4">Useful Links</p>
                ...
                <div className="w-full lg:w-4/12 lg:space-y-5 text-center z-10">
                    <p className="text-xl font-extrabold w-10/12 lg:w-4/12 m-auto pb-2 border-b-[1px]  mb-4">Contact with Us</p>
                    <p className="mt-3 lg:mt-1 "> <span className=" font-bold text-lg">Address: {address}
                    </span>  </p>
                    <p className="mt-3 lg:mt-1 "><span className="font-bold text-lg">Phone: {phone} </span> </p>
                    <p className="mt-3 lg:mt-1"><span className="font-bold text-lg">Email: {email} </span> </p>
                    <div className="flex flex-row mt-3 lg-mt-0 space-x-5 justify-center">
                        <Link target="_blank" href={`${insta}`} className="hover:cursor-pointer hover:scale-110 hover:opacity-70 hover:duration-100 hover:ease-in-out">
                        ...
                        <Link target="_blank" href={`${telegram}`} className="hover:cursor-pointer hover:scale-110 hover:opacity-70 hover:duration-100 hover:ease-in-out">
                        ...
                        <Link target="_blank" href={`${linkdin}`} className="hover:cursor-pointer hover:scale-110 hover:opacity-70 hover:duration-100 hover:ease-in-out">
