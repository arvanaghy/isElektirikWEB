...
const BackToTopButton = () => {
    ...
    return (
        <div
            onClick={scrollToTop}
            className={`fixed cursor-pointer hover:opacity-70 bottom-4 right-4 m-w-10 m-h-10 bg-black shadow shadow-black rounded-xl  transition-all duration-300  ${scrollPosition > 200 ? "opacity-70" : "opacity-0"
                } `}
            style={{ zIndex: "9999" }}
        >
