                ...
                <div className=" flex flex-col bg-[url('../images/contact-us.jpg')] py-[50px] bg-fixed space-y-28">
                    ...
                    <div className="flex flex-row">
                        ...
                        <div className="w-1/2 bg-black text-white flex flex-col space-y-4 p-10 ">
                            ...
                            <div className="mx-5">
                                <p className="text-2xl font-bold">Adress:<span className="text-lg">ksdjfhkjkiskdfjk</span></p>
                            </div>
                            <div className="mx-5">
                                <p className="text-2xl font-bold">Telephone:<span className="text-lg">2556452034</span></p>
                                </div>
