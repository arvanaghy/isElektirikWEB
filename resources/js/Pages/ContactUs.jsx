            ...
            <>
                <div className=" flex flex-col bg-[url('../images/contact-us.jpg')] py-[50px] bg-fixed space-y-28">
                    <div className="flex flex-col space-y-28 text-center">
                        <h5 className="text-white text-7xl">Contact Us</h5>
                    ...
                    <div className="flex flex-row mx-8">
                        ...
                        <div className="w-1/2 bg-black text-white flex flex-col space-y-3 p-10 rounded-r-xl shadow-xl">
                            <div className="mx-5">
                                <p className="text-2xl font-bold mb-5">Location:</p>
                                <Map />
                            </div>
                            ...
                            <div className="mx-5 flex flex-row space-x-4">
                                ...
                                <p className="text-xl font-[2000]">Open Hours:<span className="text-xl">9 - 5 </span></p>
                            </div>
