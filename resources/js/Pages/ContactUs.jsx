                ...
                <div className=" flex flex-col">
                    ...
                    <div className="flex lg:flex-row flex-col lg:m-10 lg:space-x-10">
                        ...
                        <div className="lg:w-1/2 bg-black text-white lg:gap-2 flex flex-col lg:space-y-3 space-y-1 lg:p-10 p-4 rounded-xl shadow-xl mb-2">
                            ...
                            <div className="lg:mx-5 pt-4 mx-2 flex flex-row lg:space-x-4 space-x-1">
                            ...
                            {/* <div className="lg:mx-5 mx-2 flex flex-row lg:space-x-4 space-x-1">
                                ...
                                <p className="lg:text-xl text-lg font-[2000]">Open Hours:<span className="lg:text-xl text-lg"> Monday Until Friday 9 - 17 &#9200; </span></p>
                            </div> */}
                            {/* <div className=" flex flex-col">
                                <div className="lg:mx-5 mx-2 flex flex-row lg:space-x-4 space-x-1">
                                    ...
                                    <p className="lg:text-xl text-lg font-bold lg:mb-5 mb-2">Social Media:</p>

                                    <div className="lg:mx-5 mx-2 flex flex-row lg:space-x-4 space-x-1">
                                        <a href={insta?.general_value} target="_blank" className="hover:cursor-pointer hover:scale-110 hover:opacity-70 hover:duration-100 hover:ease-in-out">
                                        ...
                                        <a href={telegram?.general_value} target="_blank" className="hover:cursor-pointer hover:scale-110 hover:opacity-70 hover:duration-100 hover:ease-in-out">
                                        ...
                                        <a href={linkdin?.general_value} target="_blank" className="hover:cursor-pointer hover:scale-110 hover:opacity-70 hover:duration-100 hover:ease-in-out">
