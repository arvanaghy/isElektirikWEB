...
const ContactUs = ({ status, canResetPassword }) => {
    ...
    return (
        <WebSiteENLayout>
            <>
                <div className=" flex flex-col bg-[url('../images/contact-us.jpg')] py-[50px] bg-fixed space-y-28">
                    <div className="flex flex-col lg:space-y-28 space-y-5 text-center mt-20">
                        <h5 className="text-white lg:text-7xl text-5xl">Contact Us</h5>
                        <p className="text-black lg:text-3xl text-xl mx-10">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates nesciunt saepe ea sequi doloribus commodi soluta quam sint, provident, a repellendus itaque quod esse voluptatibus officiis consequatur reiciendis. Quia, rerum.</p>
                    </div>
                    <div className="flex lg:flex-row flex-col lg:mx-8 mx-3">
                        <div className="lg:w-1/2 bg-white lg:rounded-l-xl shadow-xl">
                            <form onSubmit={submit} className="lg:m-10 m-5 lg:space-y-6 space-y-2">
                                <p className="lg:text-4xl text-3xl">Contact Form</p>
                                <div>
                        ...
                        <div className="lg:w-1/2 bg-black text-white flex flex-col lg:space-y-3 space-y-1 lg:p-10 p-4 lg:rounded-r-xl shadow-xl">
                            ...
                            <svg className="lg:w-7 lg:h-7 h-5 w-5" version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" xml:space="preserve" fill="#ffffff" stroke="#ffffff"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <path fill="#ffffff" d="M48,0H16c-2.211,0-4,1.789-4,4v56c0,2.211,1.789,4,4,4h32c2.211,0,4-1.789,4-4V4C52,1.789,50.211,0,48,0z M50,60c0,1.104-0.896,2-2,2H16c-1.104,0-2-0.896-2-2v-8h36V60z M50,50H14V10h36V50z M50,8H14V4c0-1.104,0.896-2,2-2h32 c1.104,0,2,0.896,2,2V8z"></path> <path fill="#ffffff" d="M32,60c1.658,0,3-1.342,3-3s-1.342-3-3-3s-3,1.342-3,3S30.342,60,32,60z M32,56c0.553,0,1,0.447,1,1 s-0.447,1-1,1s-1-0.447-1-1S31.447,56,32,56z"></path> <path fill="#ffffff" d="M33,4h-6c-0.553,0-1,0.447-1,1s0.447,1,1,1h6c0.553,0,1-0.447,1-1S33.553,4,33,4z"></path> <circle fill="#ffffff" cx="37" cy="5" r="1"></circle> </g> </g></svg>
                                <p className="lg:text-xl text-lg">Telephone:<span className="lg:text-xl text-lg">2556452034</span></p>
                            </div>
                            <div className="lg:mx-5 mx-2 flex flex-row lg:space-x-4 space-x-1">
