           ...
           <>
                <div className=" flex flex-col bg-[url('../images/contact-us.jpg')] py-[50px] bg-fixed space-y-28">
                    <div className="flex flex-col space-y-28 text-center">
                        <h5 className="text-white text-7xl">Bize Ulasin</h5>
                        <p className="text-black text-3xl mx-10">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates nesciunt saepe ea sequi doloribus commodi soluta quam sint, provident, a repellendus itaque quod esse voluptatibus officiis consequatur reiciendis. Quia, rerum.</p>
                    </div>
                    <div className="flex lg:flex-row flex-col mx-8">
                        <div className="lg:w-1/2 bg-white lg:rounded-l-xl shadow-xl">
                            <form onSubmit={submit} className="m-10 space-y-6">
                                <p className="text-4xl">Ulasim Formu</p>
                                <div>
                        ...
                        <div className="lg:w-1/2 bg-black text-white flex flex-col space-y-3 p-10 lg:rounded-r-xl shadow-xl">
                            <div className="mx-5">
                                <p className="text-2xl font-bold mb-5">Konum:</p>
                                <Map />
                            </div>
                            ...
                            <div className="mx-5 flex flex-col">
                                ...
                                <p className="text-xl font-bold mb-5">Sosyal Media:</p>
