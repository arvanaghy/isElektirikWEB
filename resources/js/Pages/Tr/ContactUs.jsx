...
import contactUsImage from "../../../../storage/app/public/contact-us.jpg";
                    ...
                    <div className=" flex flex-col">
                        <div className="bg-black py-16 bg-auto bg-no-repeat text-center flex flex-col lg:mt-0 mt-28">
                            <h5 ref={headTitle} className="text-3xl font-bold lg:text-6xl space-x-5">
                                <span className="inline-block first-letter:text-5xl lg:first-letter:text-7xl text-white">Bize Ulasin</span>
                            </h5>
                        </div>
                        <div className="flex lg:flex-row flex-col lg:m-10 lg:space-x-10">
                            ...
                            <div className="lg:w-1/2 bg-black text-white lg:gap-2 flex flex-col lg:space-y-3 space-y-1 lg:p-10 p-4 rounded-xl shadow-xl mb-2">
                                ...
                                <div className="lg:mx-5 mx-2 pt-4 flex flex-row lg:space-x-4 space-x-1">
                                    ...
                                    <p className="lg:text-xl text-lg font-[2000]">Adres: <span className="lg:text-xl text-lg">{address?.address}</span></p>
                                </div>
                                <div className="lg:mx-5 mx-2 pt-4 flex flex-row lg:space-x-4 space-x-1">
                                    ...
                                    <p className="lg:text-xl text-lg font-bold">E Posta: <span className="lg:text-xl text-lg">{email?.general_value}</span></p>
                                </div>
