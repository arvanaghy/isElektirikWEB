            ...
            <>
                <div className=" flex flex-col bg-[url('../images/contact-us.jpg')] py-[50px] bg-fixed space-y-28">
                    <div className="flex flex-col space-y-28 text-center">
                        <h5 className="text-white text-7xl">Bizimle İletişime Geçin</h5>
                        <p className="text-black text-3xl">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates nesciunt saepe ea sequi doloribus commodi soluta quam sint, provident, a repellendus itaque quod esse voluptatibus officiis consequatur reiciendis. Quia, rerum.</p>
                    </div>
                    <div className="flex flex-row">
                        <div className="w-1/2 bg-white">
                            <form onSubmit={submit} className="m-10 space-y-6">
                                <p className="text-4xl">Iletisim Formu </p>
                                <div>
                                ...
                                <div>
                                    <InputLabel htmlFor="email" value="E-posta veya Telefon Numarası" />
                                    <TextInput
                                        id="email"
                                        type="email"
                                        name="email"
                                ...
                                <div>
                                    <InputLabel htmlFor="text" value="Mesajiniz" />
                                    <TextInput
                                        id="text"
                                        type="text"
                                        name="Message"
                                ...
                                <div className="block mt-4">
                                    <label className="flex items-center">
                                        ...
                                        />
                                        <span className="ms-2 text-sm text-gray-600">Beni Hatırla</span>
                                    </label>
                                </div>
                        ...
                        <div className="w-1/2 bg-black text-white flex flex-col space-y-4 p-10 ">
                            <div className="mx-5">
                                <p className="text-2xl font-bold mb-5">Konum:</p>
                                <Map />
                            </div>
                            <div className="mx-5">
                                <p className="text-2xl font-bold">Adresimiz:<span className="text-lg">ksdjfhkjkiskdfjk</span></p>
                            </div>
                            <div className="mx-5">
                                <p className="text-2xl font-bold">Telefon:<span className="text-lg">2556452034</span></p>
                                </div>
                            <div className="flex flex-col mx-5 ">
                                <p className="text-2xl font-bold mb-5">Sosyal Media:</p>
