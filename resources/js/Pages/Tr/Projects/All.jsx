                ...
                <div className=" flex flex-col items-center justify-center px-10 py-20 ">
                    ...
                    <div className="grid lg:grid-cols-6 lg:gap-4 grid-cols-1 space-y-5 lg:space-x-5  lg:space-y-0 px-5">
                        ...
                        {projects.length > 0 && projects.map(project =>
                            <Link href={`/tr/project-details/${project.slug}`} key={project.id} className="group col-span-1 relative cursor-pointer hover:scale-105 transition-all duration-300 ease-in-out ">
